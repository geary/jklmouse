...
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\JKLmouse32.exe"
...
Section "MainSection" SEC01
  ...
  File "..\Build\JKLmouse32.exe"
  CreateDirectory "$SMSTARTUP"
  CreateShortCut "$SMSTARTUP\JKLmouse.lnk" "$INSTDIR\JKLmouse32.exe"
  ;File "Readme.html"
  ;File "upleft.gif"
  ;File "up.gif"
  ;File "upright.gif"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\JKLmouse32.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\JKLmouse32.exe"
